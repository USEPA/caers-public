<?xml version="1.0"?>
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cer="http://www.exchangenetwork.net/schema/cer/2">
	<xsl:template match="/">
		<html>
			<head>
				<style>
	...
	<xsl:template match="cer:CERS/cer:FacilitySite">
		<div class="indent2">
			...
			<table class="standard">
                ...
                <tr>
                    <td>Facility Source Type Code</td>
                    <td>
                        <xsl:value-of select="cer:FacilitySourceTypeCode"/>
                    </td>
                </tr>
				<tr>
                ...
                <tr>
                    <td>HAP Facility Category Code</td>
                    <td>
                        <xsl:value-of select="cer:HAPFacilityCategoryCode"/>
                    </td>
                </tr>
                <tr>
                    <td>Coordinate Tolerance</td>
                    <td>
                        <xsl:value-of select="cer:CoordinateTolerance"/>
                    </td>
                </tr>
				<tr>
        ...
        <xsl:apply-templates select="cer:FacilitySitePath"/>
        <xsl:apply-templates select="cer:FacilitySiteControl"/>
		...
		<div class="indent3">
			...
			<table class="standard">
				...
				<tr>
					<td>NAICS Type</td>
					<td>
						<xsl:value-of select="cer:NAICSType"/>
					</td>
				</tr>
			</table>
		</div>
	...
	<xsl:template match="cer:FacilitySite/cer:FacilitySiteGeographicCoordinates">
		<div class="indent3">
			...
			<table class="standard">
                ...
                <tr>
                    <td>Mid-point 2 Latitude Measure</td>
                    <td>
                        <xsl:value-of select="cer:MidPoint2LatitudeMeasure"/>
                    </td>
                </tr>
                <tr>
                    <td>Mid-point 2 Longitude Measure</td>
                    <td>
                        <xsl:value-of select="cer:MidPoint2LongitudeMeasure"/>
                    </td>
                </tr>
				<tr>
    ...
    <xsl:template match="cer:FacilitySite/cer:FacilitySitePath">
        <div class="indent3">
            <h2>Facility Site Path</h2>
            <table class="standard">
                <tr>
                    <td>Path Name</td>
                    <td>
                        <xsl:value-of select="cer:PathName"/>
                    </td>
                </tr>
                <tr>
                    <td>Percent Path Effectiveness</td>
                    <td>
                        <xsl:value-of select="cer:PercentPathEffectiveness"/>
                    </td>
                </tr>
                <tr>
                    <td>Path Description</td>
                    <td>
                        <xsl:value-of select="cer:PathDescription"/>
                    </td>
                </tr>
            </table>
        </div>
        <xsl:apply-templates select="cer:ControlPathIdentification"/>
        <xsl:apply-templates select="cer:ControlPathDefinition"/>
        <xsl:apply-templates select="cer:ControlPollutant"/>
    </xsl:template>
    <xsl:template match="cer:FacilitySite/cer:FacilitySitePath/cer:ControlPathIdentification">
        <div class="indent4">
            <h2>Path Identification</h2>
            <table class="standard">
                <tr>
    ...
    <xsl:template match="cer:FacilitySite/cer:FacilitySitePath/cer:ControlPathDefinition">
        <div class="indent4">
            <h2>Control Path Identification</h2>
            <table class="standard">
                <tr>
                    <td>Sequence Number</td>
                    <td>
                        <xsl:value-of select="cer:SequenceNumber"/>
                    </td>
                </tr>
                <tr>
                    <td>Average Percent Apportionment</td>
                    <td>
                        <xsl:value-of select="cer:AveragePercentApportionment"/>
                    </td>
                </tr>
            </table>
        </div>
        <xsl:apply-templates select="cer:ControlPathDefinitionControlIdentification"/>
        <xsl:apply-templates select="cer:ControlPathDefinitionPathIdentification"/>
    </xsl:template>
    <xsl:template match="cer:FacilitySite/cer:FacilitySitePath/cer:ControlPathDefinition/cer:ControlPathDefinitionControlIdentification">
        <div class="indent5">
            <h2>Path Definition Control Identification</h2>
            <table class="standard">
                <tr>
    ...
    <xsl:template match="cer:FacilitySite/cer:FacilitySitePath/cer:ControlPathDefinition/cer:ControlPathDefinitionPathIdentification">
        <div class="indent5">
            <h2>Path Definition Path Identification</h2>
            <table class="standard">
                <tr>
                    <td>Path Identifier</td>
                    <td>
    ...
    <xsl:template match="cer:FacilitySite/cer:FacilitySitePath/cer:ControlPathControlPollutant">
        <div class="indent4">
            <h2>Control Path Control Pollutant</h2>
            <table class="standard">
                <tr>
    ...
    <xsl:template match="cer:FacilitySite/cer:FacilitySiteControl">
        <div class="indent3">
            <h2>Facility Site Control</h2>
            <table class="standard">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <xsl:value-of select="cer:ControlDescription"/>
                    </td>
                </tr>
                <tr>
                    <td>Percent Control Effectiveness</td>
                    <td>
                        <xsl:value-of select="cer:PercentControlEffectiveness"/>
                    </td>
                </tr>
                <tr>
                    <td>Control Upgrade Date</td>
                    <td>
                        <xsl:value-of select="cer:ControlUpgradeDate"/>
                    </td>
                </tr>
                <tr>
                    <td>Control Upgrade Description</td>
                    <td>
                        <xsl:value-of select="cer:ControlUpgradeDescription"/>
                    </td>
                </tr>
                <tr>
                    <td>Control Status Code</td>
                    <td>
                        <xsl:value-of select="cer:ControlStatusCode"/>
                    </td>
                </tr>
                <tr>
                    <td>Control Status Code Year</td>
                    <td>
                        <xsl:value-of select="cer:ControlStatusCodeYear"/>
                    </td>
                </tr>
                <tr>
                    <td>Control Number Operating Months</td>
                    <td>
                        <xsl:value-of select="cer:ControlNumberOperatingMonths"/>
                    </td>
                </tr>
                <tr>
                    <td>Control Start Date</td>
                    <td>
                        <xsl:value-of select="cer:ControlStartDate"/>
                    </td>
                </tr>
                <tr>
                    <td>Control End Date</td>
                    <td>
                        <xsl:value-of select="cer:ControlEndDate"/>
                    </td>
                </tr>
                <tr>
                    <td>Control Comment</td>
                    <td>
                        <xsl:value-of select="cer:ControlComment"/>
                    </td>
                </tr>
            </table>
        </div>
        <xsl:apply-templates select="cer:SiteControlIdentification"/>
        <xsl:apply-templates select="cer:SiteControlPollutant"/>
    </xsl:template>
    <xsl:template match="cer:FacilitySite/cer:FacilitySiteControl/cer:SiteControlIdentification">
        <div class="indent4">
            <h2>Site Control Identification</h2>
            <table class="standard">
                <tr>
                    <td>Control Identifier</td>
                    <td>
    ...
    <xsl:template match="cer:FacilitySite/cer:FacilitySiteControl/cer:SiteControlPollutant">
        <div class="indent6">
		...
		<div class="indent4">
			...
			<table class="standard">
				...
				<tr>
					...
					<td>
						<xsl:value-of select="cer:ProcessStatusCode"/>
					</td>
				</tr>
                <tr>
                    <td>Process Status Code Year</td>
                    <td>
                        <xsl:value-of select="cer:ProcessStatusCodeYear"/>
                    </td>
                </tr>
				<tr>
	...
	<xsl:template match="cer:FacilitySite/cer:EmissionsUnit/cer:UnitEmissionsProcess/cer:ReleasePointApportionment">
		<div class="indent5">
			...
			<table class="standard">
                ...
                <tr>
                    <td>Release Point Apportionment is Uncontrolled</td>
                    <td>
                        <xsl:value-of select="cer:ReleasePointApportionmentIsUncontrolled"/>
                    </td>
                </tr>
				<tr>
        ...
        <xsl:apply-templates select="cer:ReleasePointApportionmentPathIdentification"/>
	</xsl:template>
    ...
    <xsl:template match="cer:FacilitySite/cer:EmissionsUnit/cer:UnitEmissionsProcess/cer:ReleasePointApportionment/cer:ReleasePointApportionmentPathIdentification">
        <div class="indent6">
            <h2>Release Point Path Identification</h2>
            <table class="standard">
                <tr>
                    <td>Release Point Path Identifier</td>
                    <td>
                        <xsl:value-of select="cer:Identifier"/>
                    </td>
                </tr>
	...
	<xsl:template match="cer:FacilitySite/cer:ReleasePoint">
		<div class="indent3">
			...
			<table class="standard">
                ...
                <tr>
                    <td>Release Point Width Measure</td>
                    <td>
                        <xsl:value-of select="cer:ReleasePointWidthMeasure"/>
                    </td>
                </tr>
                <tr>
                    <td>Release Point Width Unit of Measure Code</td>
                    <td>
                        <xsl:value-of select="cer:ReleasePointWidthUnitofMeasureCode"/>
                    </td>
                </tr>
                <tr>
                    <td>Release Point Length Measure</td>
                    <td>
                        <xsl:value-of select="cer:ReleasePointLengthMeasure"/>
                    </td>
                </tr>
                <tr>
                    <td>Release Point Length Unit of Measure Code</td>
                    <td>
                        <xsl:value-of select="cer:ReleasePointLengthUnitofMeasureCode"/>
                    </td>
                </tr>
				<tr>
