...
CREATE INDEX idx_report_history_reportid_action
    ON report_history USING btree
    (report_id ASC NULLS LAST, action ASC NULLS LAST);
    
CREATE INDEX idx_report_history_reportid
    ON report_history USING btree
